            ...
            <div className='max-w-11/12 mx-auto py-10'>
                <div>
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <div className='w-[50%] '>
                            <input className='w-full p-2 border rounded-md outline-0 border-orange-200' type="text" name="search" placeholder='search by car model or location' />
                        </div>
                        ...
                        <div className=''>
                            <button
                                ...
                                className="btn border-orange-200 text-orange-400"
                            >
