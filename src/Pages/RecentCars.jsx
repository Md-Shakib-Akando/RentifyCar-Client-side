...
const RecentCars = ({ car }) => {
    const { _id, createdAt, bookingCount, imageUrl, availability, dailyRentalPrice, carModel,
        description } = car;
                        ...
                        {description && (
                            <div>
                                ...
                                <div className='flex justify-end mr-3'>
                                    <Link
                                        to={`/carDetails/${_id}`}
                                        className="inline-block mt-1 text-orange-500 font-medium hover:underline"
                                    >
                                        See more
                                    </Link>
                                </div>
